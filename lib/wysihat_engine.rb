  ...
  module Helpers
    ...
    class InstanceTag #:nodoc:
      def to_wysihat_editor_tag(options = {})
        ...
        when nil, :all
          options['buttons'] = [:heading,:bold, :italic, :underline, :strikethrough, :justify_left, :justify_center, :justify_right, :insert_ordered_list, :insert_unordered_list, :undo, :redo, :link, :html, :paste, :image]
        end
